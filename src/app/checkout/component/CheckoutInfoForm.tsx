							...
							<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
								...
								<div className='md:col-span-2 space-y-2'>
									...
									<Field
										...
										className='w-full bg-gray-50 border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-primary-100/20 text-black transition-all outline-none'
									/>
									<ErrorMessage
										name='email'
										component='div'
								...
								<div className='md:col-span-2 space-y-2'>
									...
									<Field
										...
										className='w-full bg-gray-50 text-black border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-primary-100/20 transition-all outline-none'
									/>
									<ErrorMessage
										name='houseAddress'
										component='div'
